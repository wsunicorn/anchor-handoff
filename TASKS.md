...
> **Cổng hiện tại: G3** — cập nhật dòng này ở cuối mỗi phiên. (G0, G1, G2 đóng 2026-09-13.)
...
- [ ] G3.7 `pnpm eval:gate` trả mã lỗi khác 0 khi vượt ngưỡng SPEC §7; cắm vào CI — *job `rag-gate` tự dựng stack trên runner đã viết; chờ secret (#8) + quota để chạy thật và thử chặn một commit hỏng prompt*
